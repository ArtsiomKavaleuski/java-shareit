...
class ItemRequestControllerTest {
    ...
    void getAllItemRequestsByOwner() throws Exception {
        when(itemRequestService.getAllItemRequestsByOwner(anyLong())).thenReturn(Collections.emptyList());
        ...
        verify(itemRequestService, times(1)).getAllItemRequestsByOwner(anyLong());
    }
